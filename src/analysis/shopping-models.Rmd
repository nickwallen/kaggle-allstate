...
# split the customers into a training and test set
customers <- unique (data$customer.id)
customer.index <- sample (customers, 0.8 * length (customers))

# split the competition training data set 
train <- data [ customer.id %in%  customer.index ] 
test  <- data [ customer.id %nin% customer.index ]
...
# train the models
alpha.models <- cache ("train.alpha.models", 
