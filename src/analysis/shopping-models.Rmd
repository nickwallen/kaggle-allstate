...
# TODO use my "cache" function for there

fit.a <- gbm.model ("option.a", shopping.train)
fit.b <- gbm.model ("option.b", shopping.train)
fit.c <- gbm.model ("option.c", shopping.train)
fit.d <- gbm.model ("option.d", shopping.train)
fit.e <- gbm.model ("option.e", shopping.train)
fit.f <- gbm.model ("option.f", shopping.train)
fit.g <- gbm.model ("option.g", shopping.train)

# TEMP
saveRDS(fit.a, "fit.a.rds")
saveRDS(fit.b, "fit.b.rds")
saveRDS(fit.c, "fit.c.rds")
saveRDS(fit.d, "fit.d.rds")
saveRDS(fit.e, "fit.e.rds")
saveRDS(fit.f, "fit.f.rds")
saveRDS(fit.g, "fit.g.rds")
...
plot (varImp (fit.b, scale = F), top = 10)
plot (varImp (fit.c, scale = F), top = 10)
plot (varImp (fit.d, scale = F), top = 10)
plot (varImp (fit.e, scale = F), top = 10)
plot (varImp (fit.f, scale = F), top = 10)
plot (varImp (fit.g, scale = F), top = 10)
```
...
shopping.test [, option.a.hat := predict (fit.a, .SD)]
shopping.test [, option.b.hat := predict (fit.b, .SD)]
shopping.test [, option.c.hat := predict (fit.c, .SD)]
shopping.test [, option.d.hat := predict (fit.d, .SD)]
shopping.test [, option.e.hat := predict (fit.e, .SD)]
shopping.test [, option.f.hat := predict (fit.f, .SD)]
shopping.test [, option.g.hat := predict (fit.g, .SD)]
