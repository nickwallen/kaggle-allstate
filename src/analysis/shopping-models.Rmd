...
# TODO convert to a factor out here?
...
# make predictions with each model
shopping.test [, `:=` (
  option.a.hat = predict (gbm.fit.a, .SD),
  option.b.hat = predict (gbm.fit.b, .SD),
  option.c.hat = predict (gbm.fit.c, .SD),
  option.d.hat = predict (gbm.fit.d, .SD),
  option.e.hat = predict (gbm.fit.e, .SD),
  option.f.hat = predict (gbm.fit.f, .SD),
  option.g.hat = predict (gbm.fit.g, .SD)
  ), .SDcols = 2:23 ]
