...
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.a)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.b)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.c)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.d)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.e)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.f)
ggplot (train, aes (last.quote == 0)) + geom_histogram() + facet_wrap( ~ option.g)
```
